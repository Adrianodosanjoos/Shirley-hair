...
import infantil from '../../../public/trança infantil.jpg'
...
const InfantilDate = [
    {
        ...
        image: infantil ,
        description: 'trança infantil com todo cuidado para não aperta e nem machucar o couro cabeludo da sua criança',
        duration: "4h",
        price: 'Privado',
        icon: <Scissors/>,
