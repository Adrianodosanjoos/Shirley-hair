...
export function Low() {
    ...
    return (
     <div>
            ...
            <div className="bg-black text-white font-serif py-16 space-y-6 border-b border-[#373739] pb-8">
        ...
        hover:scale-110 duration-300 items-center w-fit gap-2">
                ...
                <p className="small-text lg:text-2xl font-bold flex align-text-center justify-center">R: José Cardoso Xavier, 452 Jd. Cacique-Suzano | SP</p>
