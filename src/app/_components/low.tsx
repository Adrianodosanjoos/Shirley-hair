...
export function Low() {
    ...
    return (
     ...
     data-aos-anchor-placement="center-bottom">R: José Cardoso Xavier, 452 Jd. Cacique-Suzano | SP</p>
            ...
            <Copyright className="font-bold w-4 h-4 md:mt-2 md-w-6  md-h-6 "/> <h1 className="text-xs md:text-2xl"><b>2025 Adriano dos Anjos</b> - Todos os direitos reservados</h1>
